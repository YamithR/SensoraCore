...
"   ")
    ...
    def retranslateUi(self, colorTCS):
        ...
        self.descripcion.setText(QCoreApplication.translate("colorTCS", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-style:italic;\">Monitorea la frecuencia de cada color del sensor TCS3200.</span></p></body></html>", None))
    # retranslateUi
